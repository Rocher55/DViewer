        ...
        {!! Form::open(['url' => 'research/food', 'method' => 'post']) !!}
            ...
            <div class="row group">
                <div class="col-md-6 offset-md-2 text-right">
                    ...
                    {!! Form::Number('171-from',null,['class' => 'input', 'step' => 'any']) !!}

                    {!! Form::label('171-to', 'To')  !!}
                    {!! Form::Number('171-to',null,['class' => 'input', 'step' => 'any']) !!}
                ...
                <div class="col-md-6 text-right">
                    ...
                    {!! Form::Number('167-from',null,['class' => 'input', 'step' => 'any']) !!}

                    {!! Form::label('167-to', 'To')  !!}
                    {!! Form::Number('167-to',null,['class' => 'input', 'step' => 'any']) !!}
            ...
            <div class="row group">
                <div class="col-md-6 offset-md-2 text-right">
                    ...
                    {!! Form::Number('170-from',null,['class' => 'input', 'step' => 'any']) !!}

                    {!! Form::label('170-to', 'To')  !!}
                    {!! Form::Number('170-to',null,['class' => 'input', 'step' => 'any']) !!}
                ...
                <div class="col-md-6 text-right">
                    ...
                    {!! Form::Number('164-from',null,['class' => 'input', 'step' => 'any']) !!}

                    {!! Form::label('164-to', 'To')  !!}
                    {!! Form::Number('164-to',null,['class' => 'input', 'step' => 'any']) !!}
            ...
            <div class="row group">
                <div class="col-md-6 offset-md-2 text-right">
                    ...
                    {!! Form::Number('169-from',null,['class' => 'input', 'step' => 'any']) !!}
                    {!! Form::label('169-to', 'To')  !!}
                    {!! Form::Number('169-to',null,['class' => 'input', 'step' => 'any']) !!}
                ...
                <div class="col-md-6 text-right">
                    ...
                    {!! Form::Number('166-from',null,['class' => 'input', 'step' => 'any']) !!}

                    {!! Form::label('166-to', 'To')  !!}
                    {!! Form::Number('166-to',null,['class' => 'input', 'step' => 'any']) !!}
            ...
            <div class="row group">
                <div class="col-md-6 offset-md-2 text-right">
                    ...
                    {!! Form::Number('163-from',null,['class' => 'input', 'step' => 'any']) !!}

                    {!! Form::label('163-to', 'To')  !!}
                    {!! Form::Number('163-to',null,['class' => 'input', 'step' => 'any']) !!}
                ...
                <div class="col-md-6 text-right">
                    ...
                    {!! Form::Number('168-from',null,['class' => 'input', 'step' => 'any']) !!}

                    {!! Form::label('168-to', 'To')  !!}
                    {!! Form::Number('168-to',null,['class' => 'input', 'step' => 'any']) !!}
