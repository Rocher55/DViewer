    ...
    <div class="container-body">
        {!! Form::open(['url' => 'research/cid', 'method' => 'post']) !!}
            ...
            <div class="col-md-5 col-md-offset-2">
                ...
                <select data-placeholder="Choose something..." class="single-chosen-tag"  multiple="" name="cid-from">
                    <option value=""></option>
                    @foreach($cids as $cid)
        ...
        <div class="col-md-5">
            ...
            <select data-placeholder="Choose something..." class="single-chosen-tag"  multiple="" name="cid-to">
                <option value=""></option>
                @foreach($cids as $cid)
                    <option value="{!! $cid->CID_ID !!}">{!! $cid->CID_Name !!}</option>
                @endforeach
